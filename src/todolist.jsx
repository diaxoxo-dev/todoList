...
*/
const TodoItem = ({ task, index, updateTask, deleteTask, moveTask }) => {
  return (
    <li className={`${task.completed ? "completed" : ""} ${task.selected ? "selected" : ""}`}>
      ...
      <div className="task-actions">
        ...
        <button type="button" className="move-btn" onClick={() => moveTask(index, "up")}>
          Up
        </button>
        <button type="button" className="move-btn" onClick={() => moveTask(index, "down")}>
          Down
        </button>
  ...
  */
  const [tasks, setTasks] = useState(() => {
    ...
    return savedTasks
      ...
      : [
          { id: 1, text: "Eat Breakfast", completed: false, selected: false },
          { id: 2, text: "walk the dog", completed: false, selected: false },
          { id: 3, text: "learn react", completed: false, selected: false }
        ];
  });
